test_that("warning is thrown when input for hourly plot is not valid", {
  ...
  expect_warning(check_for_valid_subset_input(period = "hour", input = "2022-06"))
})
...
test_that("warning is thrown when input for daily plot is not valid", {
  ...
  expect_warning(check_for_valid_subset_input(period = "day", input = "2022-06"))
})
...
test_that("warning is thrown when input for monthly plot is not valid", {
  ...
  expect_warning(check_for_valid_subset_input(period = "month", input = "2022-13"))
